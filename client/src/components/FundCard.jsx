...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#ededed] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          <h3 className="font-epilogue font-semibold text-[16px] yesss-yes-text-white text-left leading-[26px] truncate">{title}</h3>
