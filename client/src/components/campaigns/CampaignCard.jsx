...
const CampaignCard = ({
  ...
  return (
    <div className="border border-gray-border bg-dark-alt/70 yes-text-warm-white rounded-xl px-2">
      ...
      />
      <div className="p-3">
        <h2 className="yes-text-white line-clamp-1 font-medium">{title}</h2>
      </div>
      ...
      <div className="p-3 flex items-center justify-between">
        <div className="flex flex-col gap-0">
          <h2 className="text-lg font-bold yes-text-white">
            {amountCollected} ETH
          </h2>
